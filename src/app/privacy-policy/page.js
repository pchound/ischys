...
export default function Home() {
    return (
        ...
        <h1 className="text-3xl md:text-3xl font-bold drop-shadow-xl text-center pt-5 text-black"
         style={{ fontFamily: '"Quicksand", sans-serif', fontWeight: 300}}>
          Privacy Policy
        </h1><br></br>

        <p
          className="text-base pt-2 pb-4 mx-4 sm:mx-6 md:mx-8 lg:mx-50 text-black"
