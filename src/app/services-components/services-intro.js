...
const Intro = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto items-center px-5 pt-10">
            ...
            >
                Whether you need medication, new coping skills, or a safe place to process your experience—our work together will be personalized for your mind, body, and spirit.
            </h1>
